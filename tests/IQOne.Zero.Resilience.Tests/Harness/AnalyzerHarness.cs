...
using IQOne.Zero.Resilience.Analyzers;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.Diagnostics;

namespace IQOne.Zero.Resilience.Tests.Harness;
...
internal static class AnalyzerHarness
{
    ...
    public static async Task<AnalyzerRun> RunAsync(string source)
    {
        ...
        var reported = await compilation
            .WithAnalyzers([new HandRolledRetryAnalyzer()])
    ...
    private static ImmutableArray<MetadataReference> BuildReferences()
    {
        ...
        foreach (var type in new[] { typeof(IIdempotent), typeof(Result), typeof(Messaging.ISender) })
...
/// it reports nothing, and a test that only looked at analyzer output would call that a pass.
/// </remarks>
