...
using IQOne.Zero.BackgroundWork.Analyzers;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.Diagnostics;

namespace IQOne.Zero.BackgroundWork.Tests.Harness;
...
internal static class AnalyzerHarness
{
    ...
    public static async Task<AnalyzerRun> RunAsync(string source)
    {
        ...
        var reported = await compilation
            .WithAnalyzers([new RecurringJobAnalyzer()])
    ...
    private static ImmutableArray<MetadataReference> BuildReferences()
    {
        ...
        foreach (var type in new[] { typeof(IRecurringJob), typeof(Result) })
