...
ZERO250 | Zero.Mapping | Error | A mapped member is unaccounted for
ZERO251 | Zero.Mapping | Error | A declared member cannot fill its target
ZERO252 | Zero.Mapping | Error | A declaration does not name a settable member
ZERO253 | Zero.Mapping | Error | A member is accounted for twice
ZERO256 | Zero.Mapping | Error | A map's configuration cannot be read
